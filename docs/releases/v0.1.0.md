...
[Install with Codex](https://github.com/kizz-tech/vault-mcp-bridge/blob/v0.1.0/docs/install-with-codex.md).
...
See the
[changelog](https://github.com/kizz-tech/vault-mcp-bridge/blob/v0.1.0/CHANGELOG.md),
[threat model](https://github.com/kizz-tech/vault-mcp-bridge/blob/v0.1.0/docs/threat-model.md), and
